...
const whitelist = ['https://admin.dev.saaditrips.com', 'https://admindev.saaditrips.com', 'http://localhost:8080', 'http://localhost:8081', 'http://localhost:8082', 'http://localhost:8083', 'https://dev.saaditrips.com'];
const corsOptions = {
